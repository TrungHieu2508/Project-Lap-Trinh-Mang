...
class AppLauncher:
    ...
    def create_main_screen(self):
        ...
        teacher_btn = tk.Button(header_frame, text="Đăng nhập Admin",
                                font=("Arial", 10, "bold"),
        ...
        tk.Label(frame, text="User nhập mã đã được cung cấp:",
    ...
    def open_teacher_login(self):
        ...
        tk.Label(self.root, text="Đăng nhập dành cho Admin",
    ...
    def connect_as_student(self):
        ...
        if not code:
            self.status_label.config(text="Vui lòng nhập mã code trước.")
            return
